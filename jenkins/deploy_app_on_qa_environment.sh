...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-ridvan-petclinic-helm-chart/stable/myapp/ || echo "repository name already exists"
